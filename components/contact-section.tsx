...
export function ContactSection() {
  ...
  <div className="container mx-auto px-4">
        <div className="text-center mb-16 w-full">
          <h2 className="text-3xl md:text-5xl font-bold text-primary mb-6 text-balance">¡Contáctanos!</h2>
  ...
  <div className="grid lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
          <div className="space-y-6">
            <h3 className="text-2xl font-bold text-primary mb-8">Nuestros Canales de Contacto</h3>
                ...
                <CardContent className="p-6">
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex-1">
                      <h4 className="font-semibold text-primary">WhatsApp Principal</h4>
                      <p className="text-muted-foreground">0983549657</p>
                    </div>
                    <Button onClick={handleWhatsApp1} className="bg-green-500 hover:bg-green-600">
                      Escribir
                    </Button>
                  </div>
                </CardContent>
              ...
              <Card className="hover:shadow-lg transition-shadow duration-300 border-2 hover:border-accent/50">
                <CardContent className="p-6">
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex-1">
                      <h4 className="font-semibold text-primary">WhatsApp Secundario</h4>
                      <p className="text-muted-foreground">0993870647</p>
                    </div>
                    <Button onClick={handleWhatsApp2} className="bg-green-500 hover:bg-green-600">
                      Escribir
                    </Button>
                  </div>
                </CardContent>
              ...
              <Card className="hover:shadow-lg transition-shadow duration-300 border-2 hover:border-accent/50">
                <CardContent className="p-6">
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex-1">
                      <h4 className="font-semibold text-primary">Facebook</h4>
                      <p className="text-muted-foreground">@todofiestaimportadora</p>
                    </div>
                    <Button onClick={handleFacebook} className="bg-blue-600 hover:bg-blue-700">
                      Seguir
                    </Button>
                  </div>
                </CardContent>
          ...
          <div className="space-y-6">
            <h3 className="text-2xl font-bold text-primary mb-8">Nuestra Ubicación</h3>
              ...
              <CardContent className="p-0 h-full">
                <div className="h-full min-h-[20rem] w-full">
                  <iframe
                    ...
                    width="100%"
                    height="100%"
                    style={{ border: 0, minHeight: '20rem', height: '100%', width: '100%' }}
