...
export function HeroSection() {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-primary/10 via-background to-accent/10 w-full overflow-x-hidden">
      <div className="absolute inset-0 w-full h-full">
        <img src="/Hero.jpg" alt="Hero" className="w-full h-full object-cover" style={{maxWidth:'100vw'}} />
